...
opcion = ""   # arranco vacío para entrar al while y comentar algo
...
while opcion != "8":
    ...
    match opcion:
        ...
        case "3":
            ...
            if len(herramientas)==0: print("(sin herramientas)")
            else:
                k=0
                while k<len(herramientas):
                    print(herramientas[k],"->",existencias[k])
                    k+=1
        ...
        case "7":
            ...
            print("Actualizar existencias (venta / ingreso)")
            nombre = input("Nombre: ").strip()
            if nombre == "":
                print("El nombre no puede estar vacío.")
                continue
        ...
        case _:
            print("Opción inválida. Elegi bien!")